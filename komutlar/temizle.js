...
exports.conf = {
  enabled: true,
  guildOnly: true,
  aliases: ['sirthrthtrhtrhtrhl','süpürthtrhtrhtrhtrtrr','terthtrhtrhrhtrhtrmiz'],
  permLevel: 1
};

exports.help = {
  name: 'temizlrthtrhtrhtrhrte',
  description: 'Belirlenen miktarda mesajı siler.',
  usage: 'temizrhrthtrhrthtrhtrhrle <silinicek mesaj sayısı>'
};